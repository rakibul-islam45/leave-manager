...
@FilterDef(name = "deletedLeaveRequestFilter", parameters = @ParamDef(name = "isDeleted", type = boolean.class))
@Filter(name = "deletedLeaveRequestFilter", condition = "deleted = :isDeleted")
